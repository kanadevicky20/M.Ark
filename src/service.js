...
function Service(){
    ...
    return(
      ...
      <div className="container py-5">
        <div className="row">
        <div className="col-lg-6 pr-lg-5 text-left">
  <h6 className="text-primary font-weight-normal text-uppercase mb-3">Our Awesome Services</h6>
  <h1 className="mb-4 section-title">Transformation of Spaces through Visionary Architectural Solutions.</h1>
  <p>
    M.ark Design Studio creates innovative, functional, and visually striking architectural solutions for townships, 
    commercial spaces, and residential developments. Designing firm that offers design and decorating solutions to 
          ...
          <div className="col-lg-6 p-0 pt-5 pt-lg-0">
            <div className="owl-carousel service-carousel position-relative">
              ...
              <div className="d-flex flex-column text-left bg-light mx-3 p-4">
                ...
                <p className="m-0">
                  Landscape design is the art of arranging or modifying the features of a yard, an urban area, etc., for aesthetic 
                  or practical reasons. For organizational purposes, it is often divided into two major parts: hardscape and softscape.
                </p>
              </div>
            </div>
          </div>
